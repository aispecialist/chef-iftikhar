...
const Home = () => {
  ...
  <div className="carousel-inner">
    <div className="carousel-item  active" data-bs-interval={10000}>
      <img src="pakistani1.jpg"  className="d-block  w-100" alt="this is alright..wait for loading....." />
    ...
    <div className="carousel-item " data-bs-interval={2000}>
      <img src="salad1.jpg" className="d-block w-100" alt="..." />
      <div className="carousel-caption d-none d-md-block">
    ...
    <div className="carousel-item ">
      <img src="thai1.jpg"  className="d-block w-100" alt="..." />
      <div className="carousel-caption d-none d-md-block">
    ...
    <div className="carousel-item ">
      <img src="di1.jpg"  className="d-block w-100" alt="..." />
      <div className="carousel-caption d-none d-md-block">
    ...
    <div className="carousel-item ">
      <img src="dr1.jpg"  className="d-block w-100" alt="..." />
      <div className="carousel-caption d-none d-md-block">
    ...
    <div className="carousel-item ">
      <img src="ch1.jpg"  className="d-block w-100" alt="..." />
      <div className="carousel-caption d-none d-md-block">
